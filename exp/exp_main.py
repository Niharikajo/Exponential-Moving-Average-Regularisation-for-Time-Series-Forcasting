...
class ExpMain(ExpBasic):
    ...
    def test(self, phase='test', load_best_checkpoint=True):
        ...
        #print('trues shape', trues.shape) #319, 96, 3
        #print('preds shape',preds.shape) #319, 96, 3
        ...
        trues = trues.reshape(d*e,f)

        preds = self.Data.inverse_transform(preds)
        trues = self.Data.inverse_transform(trues)
